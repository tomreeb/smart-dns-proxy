...
[![do](https://raw.githubusercontent.com/tomreeb/smart-dns-proxy/master/static/digitalocean.png)](https://m.do.co/c/937b01397c94)
...
2. Set your DNS server to the IP given at the end of the script, then go to [this](http://ifconfig.co/) site to make sure the same IP is displayed.
3. Finally, enjoy `Netflix` and others out of region.
4. Enjoy or try `#netflix-proxy` on [freenode](https://webchat.freenode.net/?channels=netflix-proxy) for help.
...
[![a](https://raw.githubusercontent.com/tomreeb/smart-dns-proxy/master/static/admin.png)](https://raw.githubusercontent.com/tomreeb/smart-dns-proxy/master/static/admin.png)
...
[![v](https://raw.githubusercontent.com/tomreeb/smart-dns-proxy/master/static/vultr.png)](http://www.vultr.com/?ref=6871746)
...
[![k](https://raw.githubusercontent.com/tomreeb/smart-dns-proxy/master/static/kamatera.png)](https://www.kamatera.com/express/compute/?tcampaign=antonbelodedenko&HT=17)
...
[![a](http://www.ramnode.com/images/banners/affbannerdarknewlogo.png)](https://clientarea.ramnode.com/aff.php?aff=3079)
...
[![l](https://www.linode.com/media/images/logos/standard/light/linode-logo_standard_light_small.png)](https://www.linode.com/?r=ceb35af7bad520f1e2f4232b3b4d49136dcfe9d9)
...
[![d](https://raw.githubusercontent.com/tomreeb/smart-dns-proxy/master/static/dreamhost.png)](http://www.dreamhost.com/r.cgi?2124700)
...
[![g](https://raw.githubusercontent.com/tomreeb/smart-dns-proxy/master/static/gandi.png)](https://www.gandi.net/hosting/iaas/buy)
...
1. Use the [Azure Management Portal](https://manage.windowsazure.com/) to add `DNS (UDP)`, `HTTP (TCP)` and `HTTPS (TCP)` endpoints and secure them to your home/work/whatever IPs using the Azure `ACL` feature.
...
| Paypal | Bitcoin |
| ------ | ------- |
|[![pp](https://www.paypalobjects.com/en_GB/i/btn/btn_donateCC_LG.gif)](https://www.paypal.com/donate?hosted_button_id=EJHRS4KH8LZZC)|![32BJ4ZYWAbuVuDSBGwRQaNH4jr4Z31rpW3](https://raw.githubusercontent.com/tomreeb/smart-dns-proxy/master/static/bitcoin_qr.png)32BJ4ZYWAbuVuDSBGwRQaNH4jr4Z31rpW3|
